            ...
            <div className=' pt-lg-5 mt-md-5'>
                <div className=' container mt-5 pt-sm-5 pt-3 max-w-1140'>
                    <div className=' row pt-4 justify-content-lg-around align-items-center'>
                        <div className=' col-lg-5 mx-auto col-md-9 col-sm-11'>
                            <img src={img} alt="ig" className=' w-100' />
                        </div>
                        <div className="col-lg-6 col-md-11 mt-5 mt-lg-0 d-flex align-items-center justify-content-center flex-column">
