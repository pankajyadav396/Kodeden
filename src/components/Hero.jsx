...
import imgvideo from '../assets/images/webp/herovideo.webp'
    ...
    <>
      <div className=' d-flex bg-header flex-column position-relative'>
        ...
        <div className=' container-md max-w-1140 pt-5 mt-3'>
          ...
          <div className=' d-none d-md-flex flex-column d-inline-block position-fixed z-2 mx-auto mt-4 mt-md-0 gap-2 py-2 px-1 bg-white box-absolute'>
